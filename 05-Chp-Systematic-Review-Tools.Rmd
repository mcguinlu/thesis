...
``` {r trafficplot, echo = FALSE, eval = TRUE, fig.cap = "Example risk of bias traffic light plot created using `robvis`", out.width = "100%", out.height = "100%", fig.align = "centre"}

plotdata <- robvis::data_rob2

tfplot <- robvis::rob_traffic_light(data = plotdata, "ROB2", psize = 15) 

ggplot2::ggsave(
          filename = "figures/sys-rev-tools/example-rob-traffic-light-plot.png",
          plot = tfplot,
          width = 7,
          height = 8,
          dpi = 400
...
knitr::include_graphics("figures/sys-rev-tools/example-rob-traffic-light-plot.png")
```
...
``` {r summaryplot, echo = FALSE, eval = TRUE, fig.cap = "Example risk of bias summary plot created using `robvis` and the example ROB2 dataset", out.width = "100%", out.height = "100%"}
...
ggplot2::ggsave(
          filename = "figures/sys-rev-tools/example-rob-summary-barplot.png",
          plot = sumplot,
          width = 8,
          height = 2.41,
          dpi = 400
