...
[Fourthly, despite their wide use in the existing literature (as illustrated in the systematic review in Chapters]{.correction} \@ref(sys-rev-methods-heading) [&]{.correction} \@ref(sys-rev-results-heading) [), the clinical validity of dementia subtypes could be questioned and may lead to spurious results. This is supported by the difficulty in diagnosing a specific dementia subtype, and findings from population-based autopsies samples suggesting that "pure" Alzheimer's/vascular dementia outcomes are rare when compared to "mixed" dementia outcomes in older age groups, as discussed in detail in the Introduction (see Section]{.correction} \@ref(underlying-pathologies)[). In this case, results for the all-cause dementia outcome may be the most clinically useful, but were not the focus of the final chapters of these thesis.]{.correction}
