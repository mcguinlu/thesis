...
Allowing for a two year lag, previous work has found that two-thirds of bioRxiv preprints were published in a peer-reviewed journal,[@abdill2019b] indicating that s not-insignificant number of preprints are never publishe but are accessible as preprints.
