...
```{r mrAssumptions, echo = FALSE, results="asis", fig.pos = "H", fig.cap='(ref:mrAssumptions-cap)', out.width='70%', fig.scap='(ref:mrAssumptions-scap)'}
...
```{r preprintGrowth, echo = FALSE, results="asis", fig.pos = "H",fig.align='center',fig.cap='(ref:preprintGrowth-cap)', out.width='100%', fig.scap='(ref:preprintGrowth-scap)'}
