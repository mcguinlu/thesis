...
Of the `r comma(attrition[1,1])` participants included in our extract, `r comma(attrition[14,1])` met the inclusion criteria (Figure \@ref(fig:cprdFlowchart)), with a total follow-up of `r comma(total_followup)` <!--- TODO make this reactive! ---> patient years at risk. 
...
<!--- TODO Describe impact of SSA table - is the fact that many people stopped statin treatment (~10%) an issue? --->
...
<!--- TODO In my most recent discussion with supervisors, I discussed that a long term RCT isn't encouraged by the results --->
