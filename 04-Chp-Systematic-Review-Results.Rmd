...
<!----------------------------------------------------------------------------->
(ref:agreeInter-caption) __Inter-rater agreement__ - For a subset of records, the decisions between two independent were compared. Gewt's $AC1$ was calculated from this data to assess inter-rater reliability, indicating high accuracy ($AC1$ = `r agreeInter_coeff[1]`). 
...
(ref:cohortLocations-cap) __Geographical distribution of study cohorts__ - The country or countries of origin for the studies include in the review are shown below. Note that the majority of included studies were performed in the Western world, predominantly in Europe and North America.
