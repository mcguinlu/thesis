...
One item of particular interest is the attenuation of any effects identified by Mendelian randomisation studies following the adjustment for/exclusion of genetic variation in the Apoe4 gene region. As discussed in the introduction (see Section \@ref(intro-basic-science)), an increasing number of ApoE4 alleles is a major independent risk factor for Alzheimer's disease and so violates the exclusion restriction criteria of Mendelian randomisation studies (Figure \@ref(fig:mrAssumptions)). In all cases, excluding variants in the ApoE region attenuates the observed effect to the null. A clear example of this is Benn _et al_ (2017), where ApoE variants were not sufficient identified and excluded, leading the published paper to report a protective effect of LDL-c on Alzheimer's (`r estimate(0.83, .75,.92,"RR")`).[@benn2017] Following several rapid responses, the data was re-analysed to exclude a larger area around ApoE which attenuated the finding to the null.[@benn2017comment]
