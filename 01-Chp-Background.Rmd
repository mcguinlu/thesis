...
[However, evidence from longitudinal studies indicates the challenge of assigning a subtype to dementia outcomes, given the known heterogeneity in clinical phenotypes.]{.correction} [@rooney2017] [For example, ]{.correction} [@shim2013]
...
Multimorbidity is common among people with dementia, with those diagnosed frequently having two or more other chronic conditions.[@poblador-plou2014]

Patients with dementia have a higher risk of diabetes, stroke, depression pneumonia, falling and infection
...
Given the substantial burden that dementia represents and the absence of any curative therapies, as detailed in the above sections, the assessment of easily modifiable targets for their utility in the prevention of dementia should be prioritized.[@winblad2016] [Well-studied risk factors for the condition include cardiovascular factors (e.g. hypertension), education, diabetes, and smoking.]{.correction}[@anstey2019] The benefits of a prevention-based approach based on addressing known risk factors for dementia are well-studied. Reducing the prevalence of the seven most important risk factors for dementia (obesity, hypertension, diabetes, smoking, physical inactivity, [depression,]{.correction} and low educational attainment) by 10-20% per decade is estimated to result in a reduction in dementia prevalence of 8-15% by 2050.[@norton2014potential]
...
[A final general limitation of studies of statin use is their limited ability to assess a causal link between lipid levels and dementia. This is caused by the pleiotropic effect of statins, which may effect dementia risk via some non-lipid-lowering pathway. For example, statins influence the levels of C-reactive protein,]{.correction}[@albert2001] [an independent risk factor for dementia.]{.correction}[@lewis2021; @schmidt2002] 
