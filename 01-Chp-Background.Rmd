...
[Finally, the ability of studies of statin use to assess a causal link between lipid levels and dementia is limited by the pleiotropic effect of the intervention, as statins may effect dementia risk via some non-lipid-lowering pathway. For example, statins influence the levels of C-reactive protein,]{.correction}[@albert2001] [an independent risk factor for dementia.]{.correction}[@lewis2021; @schmidt2002] 
