...
As part of this research, I attempted to obtain the raw data from relevant primary studies identified by the systematic review presented in Chapters \@ref(sys-rev-methods-heading) & \@ref(sys-rev-results-heading). Data obtained were combined with that available from the DPUK portal as part of an IPD meta-analysis in Chapter \@ref(ipd-heading). This enabled the assessment of the effect of lipids on dementia, and whether this relationship is modified by key variables such as participants' age or sex.
```
