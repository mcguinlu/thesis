...
_Note: If protocol was written by Venexia, how do I reference this?_
...
<!--- Show comparison of code lists here --->

<!----------------------------------------------------------------------------->
``` {r smeeth-comparison-setup, results="hide", message=FALSE}
```

```{r smeeth-comparison-table, message=FALSE, results="asis"}
```
<!----------------------------------------------------------------------------->
