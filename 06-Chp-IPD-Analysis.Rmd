...
<!-- TODO Note here about how the IHD variable in CAPS has a note saying there might be an issue with the variables, while the Whitehall study uses narrow range of codes to define CHD. EPIC is selfreported angina/mi/arrythmia -->
...
<!-- TODO If using fixed effect model, need to udate subgroup labels to reflect this -->
