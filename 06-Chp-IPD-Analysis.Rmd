...
<!-- At the same time, I will write to authors to obtain anonymised data on individual participants. The data from each study will be combined using a technique known as individual participant data (IPD) meta-analysis. This will allow me to examine if the relationship between lipids in dementia depends on any patient characteristics (e.g. sex or age). -->
