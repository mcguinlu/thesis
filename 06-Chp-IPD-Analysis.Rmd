...
<!-- Previous SWARs have been registered as protocols, but have not yet reported! - Not sure this is actually true! Double check. -->
...
<!-- While the cohort response rate was substantially lower that expected, given the time and resource intensity of data cleaning and harmonisation for just 4 cohorts, all full-scale IPD would have been logisitically challenging. It is positive that off the cohorts analysed, the majority represented new data not previously considered -->
