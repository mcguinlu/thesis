...
Rater reliability was assessed using Gwet's agreement coefficient ($AC1$).[@gwet2008] This approach was chosen over other measures such as percent agreement because it accounts for chance agreement between reviewers but does not suffer from bias due to severely imbalanced marginal totals in the same way that Cohen's $kappa$ value does. [@cohen1960: @gwet2008; @wongpakaran2013] Given the small number of included studies in this review as a proportion of the total number screened, this is a useful characteristic. The formulae used to calculate $AC$ are given in Appendix \@ref(appendix-gwet). 
