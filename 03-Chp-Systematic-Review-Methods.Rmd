...
<!----------------------------------------------------------------------------->
(ref:searchOverview-caption) __Summary of systematic search by topic__ - The full search strategy including all terms and the number of hits per term is included in Appendix \@ref(appendix-search-strategy).
...
<!----------------------------------------------------------------------------->
(ref:gwet-caption) __Ranges for Gwet's AC1__ - To aid the interpretation of inter-/intra-rater reliability, I used a published set of suggested categories for Gwet's AC1.[@mchugh2012]
