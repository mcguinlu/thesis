...
<!-- IDEA Stratify by _ApoE4_ genotype -->  
...
In line with best practice, where summary data were presented across two groups (e.g. age at baseline stratified by hypercholesterolemia status), the following approach was used to combine the groups:[@higgins2019]
