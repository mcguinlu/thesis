...
## Qualitative (narrative) triangulation 
...
In addition to the qualitative discussion of the evidence presented in Section (\@ref(qual-tri)), I attempted to integrate the numerical results of the multiple approaches under a proposed quantitative triangulation framework. This approach incorporates recent advancements in the way that bias in results is assessed (namely the move to domain-based assessment tools)[@sterne2019] and existing methods for bias-/indirectness-adjusted meta-analysis[@turner2009] to illustrate how causal questions could be addressed under this framework.
