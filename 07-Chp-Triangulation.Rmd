...
<!-- TODO Update this paragraph to reflect extra 2 MR studies -->

From the data sources identified in Section \@ref(tri-data-sources), I identified 18 results relevant to my first causal question of interest. Most (N =17) were identified via the systematic review,`r ldl_ad_citations` while Chapter \@ref(cprd-analysis-heading) provided an additional estimate via the CPRD analysis.  The extent, type and direction of predicted bias for each result can be seen in the bias-direction plot presented in Figure \@ref(fig:ldlAdBiasDirection), stratified by study design.

<!-- TODO Double check this reference list is correct! -->  
