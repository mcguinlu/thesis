...
#####################
title: |
   Determining the causal effects of lipid levels on risk of dementia: a triangulation of new and existing evidence
...
word-count: |
  `r read.csv("data/words/words.csv") %>% dplyr::pull(1) %>% dplyr::last() %>% comma()`
abstract: |
