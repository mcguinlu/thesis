...
\caption[Inter-rater agreement]{\label{tab:agreeInter-table}\textbf{Inter-rater agreement} - For a subset of records, the decisions between two independent reviewers were compared. Gewt's \(AC1\) was calculated from this data to assess inter-rater reliability, indicating high accuracy (\(AC1\) = 0.97).}
\centering
