...
\end{tabular}
\begin{tablenotes}
\item \textbf{Key:} Complete - No missing values; X - Variable not recorded/available in this cohort; * - LDL values derived from total cholesterol, HDL and triglycerides.
\end{tablenotes}
\end{threeparttable}
\end{table}
