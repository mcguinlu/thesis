...
\caption[biasData]{\label{tab:biasData-table}biasData}
\centering
\fontsize{10}{12}\selectfont
...
\caption[biasDirectionData]{\label{tab:biasDirectionData-table}biasDirectionData}
\centering
\fontsize{10}{12}\selectfont
\begin{tabular}[t]{lrrllllllllllllllll}
\toprule
\textbf{Study} & \textbf{yi} & \textbf{sei} & \textbf{d1j} & \textbf{d1d} & \textbf{d1t} & \textbf{d2j} & \textbf{d2d} & \textbf{d2t} & \textbf{d3j} & \textbf{d3d} & \textbf{d3t} & \textbf{d4j} & \textbf{d4d} & \textbf{d4t} & \textbf{d5j} & \textbf{d5d} & \textbf{d5t} & \textbf{overall}\\
\midrule
Study  1 & 0.11 & 0.05 & Serious & Right & A & Moderate & Unpredictable & A & Low &  &  & Low &  &  & Low &  &  & Serious\\
Study  2 & 0.02 & 0.15 & Moderate & Left & A & Moderate & Unpredictable & A & Low &  &  & Low &  &  & Low &  &  & Moderate\\
Study  3 & -0.06 & 0.13 & Moderate & Left & A & Moderate & Unpredictable & A & Low &  &  & Low &  &  & Low &  &  & Moderate\\
Study  4 & -0.11 & 0.18 & Moderate & Left & A & Moderate & Unpredictable & A & Low &  &  & Low &  &  & Low &  &  & Moderate\\
Study  5 & -0.12 & 0.18 & Serious & Left & A & Low &  &  & Low &  &  & Low &  &  & Low &  &  & Serious\\
\bottomrule
\end{tabular}
\end{table}
