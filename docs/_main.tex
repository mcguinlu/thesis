...
It has been widely used in the literature, and is comparable to Bradford-Hill's criteria of ``consistency'', that is the replication of an observed relationship across several different contexts.\textsuperscript{\protect\hyperlink{ref-hill1965}{314}} In this framework,
...
In addition to the qualitative discussion of evidence, I attempted to integrate the numerical results of the multiple approaches. This proof-of-concept approach incorporated advancements in the way that bias in results is assessed (domain-based assessment tools) and existing methods for bias-adjusted meta-analysis\textsuperscript{\protect\hyperlink{ref-turner2009}{315}} to to illustrate how causal questions could be addressed under this quantitative triangulation framework.
...
\item
  Perform bias-adjusted meta-analysis using bias-/indirectness-adjusted results
\end{enumerate}
...
\textbf{Low} & - & -\\
\midrule
\textbf{Moderate} & N(.3, .12) & N(.3, .12)\\
\midrule
\textbf{High} & N(.3, .12) & N(.3, .12)\\
\bottomrule
\end{tabular}
\end{table}
...
Using the method defined in Turner \emph{et al},\textsuperscript{\protect\hyperlink{ref-turner2009}{315}} the adjusted estimate for each result is defined as:
...
Elicitation and bias-adjusted not as favoured versus weighting\textsuperscript{\protect\hyperlink{ref-stone2020}{318}} though weighting at the overall risk-of-bias level loses some of the information contained in domain-level based assessments.

No good information on what the potential distributions for different levels of bias (High vs Moderate vs Low) should be.

Meta-epidemiological studies on the effect of different methodological issues on results exist for randomised controlled trials,\textsuperscript{\protect\hyperlink{ref-amer2021}{319},\protect\hyperlink{ref-page2016}{320}} suggesting that X, Y and Z.
...
\hypertarget{defining-appropriate-levels-of-bias}{%
\subsubsection{Defining appropriate levels of bias}\label{defining-appropriate-levels-of-bias}}
...
Talk about different ways to define bias terms, using expert-elicitation vs .\textsuperscript{\protect\hyperlink{ref-rhodes2020}{321}}
...
\hypertarget{type-of-bias-proportional-vs-additive-not-shown-on-figure}{%
\subsubsection{Type of bias (proportional vs additive) not shown on figure}\label{type-of-bias-proportional-vs-additive-not-shown-on-figure}}
...
E-values work the other way around - get result then work out how strong a biasing factor would have to be to negate the result. IN other words, they represent an estimate ho how strong the total residual confounding would have to be in order to full explain away the observed result.\textsuperscript{\protect\hyperlink{ref-vanderweele2017}{322}}
...
Need for large simple trials for common disease where small treatment effect can have large effect -\textsuperscript{\protect\hyperlink{ref-yusuf1984}{323}}
...
\leavevmode\hypertarget{ref-vanderweele2017}{}%
\CSLLeftMargin{322. }
\CSLRightInline{VanderWeele, T. J. \& Ding, P. Sensitivity {Analysis} in {Observational Research}: Introducing the {E}-{Value}. \emph{Annals of Internal Medicine} \textbf{167}, 268--274 (2017).}
...
All projects in these thesis attempt to conform to minimal best practices for research computing.\textsuperscript{\protect\hyperlink{ref-wilson2014}{324},\protect\hyperlink{ref-wilson2017}{325}}
