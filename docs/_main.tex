...
The tool has been well received by the community (as of December 2021, \texttt{medrxivr} has been downloaded more than 4200 times), and several use cases have been reported. It has been used to investigate the role of preprints in the response to the 2019 coronavirus outbreak,\textsuperscript{\protect\hyperlink{ref-kodvanj2020}{105}} perform searches of preprints as part of a systematic review,\textsuperscript{\protect\hyperlink{ref-noone2020}{106},\protect\hyperlink{ref-grassly2020}{107}} and examine how data-sharing behaviour is affected by journal policies (see \ref{thesis-output}).\textsuperscript{\protect\hyperlink{ref-mcguinness2020c}{\textbf{mcguinness2020c?}}}
...
\hypertarget{converting-between-different}{%
\subsubsection{Converting between different}\label{converting-between-different}}
...
\includegraphics[width=4.56in]{_main_files/figure-latex/studyCharacteristics-table-1}
