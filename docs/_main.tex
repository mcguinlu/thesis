...
This study was reported in line with the Strengthening the Reporting of Observational Studies in Epidemiology (STROBE) reporting guidelines\textsuperscript{\protect\hyperlink{ref-vandenbroucke2007}{186}} (see Appendix @ref() for the STROBE checklist)

Reporting guidelines do not always work, but help to guide

All code and summary statistics (i.e.~the tables presented in this chapter, plus summary tables of effect estimates) are readily available in machine readable formats, without any formatting (i.e.~as comma separated values, or CSV, files) from the Github repository for this project.
