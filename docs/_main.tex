...
\includegraphics[width=3.00in,height=1.75in,keepaspectratio]{_main_files/figure-latex/gwet-table-1.png}
...
\begin{figure}
\includegraphics[width=1\linewidth]{_main_files/figure-latex/prisma-flow-1} \caption{PRISMA flow diagram, detailing the movement of studies through the systematic review.}\label{fig:prisma-flow}
\end{figure}
...
\qauthor{--- Harold F. Dorn, 1953\textsuperscript{\protect\hyperlink{ref-dorn1953}{30}}}\end{savequote}
...
Because they R.
\qauthor{--- Bealy, 2013\textsuperscript{\protect\hyperlink{ref-bealy2013}{32}}}\end{savequote}
