...
for (file in 1:length(files)) {
  tmp <- wordcountaddin::word_count(files[file])
...
target <- (date_diff*200)+5580

words_behind <- target - words$words[which(words$date == max(words$date))]
...
Word count: `r words$words`

Days: `r date_diff`

Words behind: `r words_behind`
