...
<!----------------------------------------------------------------------------->
(ref:prismaTab-caption) __PRISMA Checklist__ - Following best practice guidelines, the Section/Table/Figure number were important details on the systematic review can be found are listed.
...
(ref:drDemeniaTC-cap) __Dose-response meta-analysis of total cholesterol on all-cause dementia__
...
(ref:drAdLDL-cap) __Dose-response meta-analysis of low-density lipoprotein cholesterol on Alzheimer's disease__
...
<!----------------------------------------------------------------------------->
(ref:robSummary-cap) __Example risk-of-bias summary barplot__ - Illustration of a simple summary barplot created using the `data_rob` example risk-of-bias dataset shown in Table \@ef(tab:biasData-table) above. Note that this plot is unweighted and shows the _proportion of studies_ at each level of bias, but an option exists with `robvis` to create a barplot weighted by the _proportion of evidence_ at each level of bias. 
...
<!----------------------------------------------------------------------------->
(ref:robTraffic-cap) Example risk-of-bias traffic-light plot - Illustration of a simple traffic light plot created using the `data_rob` example risk-of-bias dataset shown in Table \@ef(tab:biasData-table) above.
