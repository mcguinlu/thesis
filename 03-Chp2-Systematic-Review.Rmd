...
# Chapter 2: Systematic Review {#sys-rev-heading}
...
```{r prisma-flow, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="PRISMA flow diagram, detailing the movement of studies through the systematic review."}
```
