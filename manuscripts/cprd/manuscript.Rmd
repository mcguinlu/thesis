...
* Main text word count (max 4000): 3104
...
_Figure 1: Results from the primary analyses of CPRD data comparing prescription of an lipid-regulating drug with no prescription, stratified by dementia outcome and drug class. All results were obtained using the fully adjusted model and participant age as the time scale._
