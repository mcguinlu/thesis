...
For our control outcomes (Supplementary Figure 6), there was some evidence that patients prescribed a lipid-regulating agent had increased risks of back pain (`r backpain_text`), ischaemic heart disease (`r ihd_text`) and Type 2 diabetes (`r dm_type2_text`).
